...
GEM5_DIR=/home/biswas/gem5                          # Install location of gem5
SPEC_DIR=/home/biswas/specbench                  # Install location of your SPEC2006 benchmarks
##################################################################
...
RUN_DIR=$SPEC_DIR/benchspec/CPU2006/$BENCHMARK_CODE/run/run_base_test_gcc43-64bit.0000     # Run directory for the selected SPEC benchmark

#RUN_DIR=/bin     # Run directory for the selected SPEC benchmark
...
$GEM5_DIR/build/X86/gem5.opt --outdir=$OUTPUT_DIR $GEM5_DIR/configs/example/spec06_config.py --benchmark=$BENCHMARK --benchmark_stdout=$OUTPUT_DIR/$BENCHMARK.out --benchmark_stderr=$OUTPUT_DIR/$BENCHMARK.err -I 10000000 -n 1 --caches | tee -a $SCRIPT_OUT
